...
{#snippet albumOverview()}
	...
	>
		<div class="relative mx-5 mt-19 flex max-w-full items-center justify-center">
			...
			<div
				class="font-Fredoka overflow z-20 m-8 h-full w-7xl max-w-full overflow-hidden text-center leading-[110%] font-semibold text-balance overflow-ellipsis text-white opacity-0"
